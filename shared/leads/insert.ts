...
export function buildLeadInsert(
  ...
  return {
    row: {
      ...
      canal_venda: data.canal_venda ?? null,
      ...
      respondentes: data.respondentes ?? null,
      registro_contatos: data.registro_contatos ?? null,
      automatizar_primeiro: data.automatizar_primeiro ?? null,
